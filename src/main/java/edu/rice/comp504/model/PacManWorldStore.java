...
public class PacManWorldStore {
    ...
    private static String[] colors = {"red", "Aqua", "magenta", "orange"};
    ...
    public static void init() {
        ...
        for (int i = 0; i < colors.length; i++) {
            ghost.add(gamObjectFac.makeGhost(11 + i, 10, "null", colors[i], strategyFac.makeStrategy("SimpleGhostStrategy")));
        }
